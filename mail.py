...
sender_add='helloabcd234566@gmail.com' #storing the sender's mail id
receiver_add='rashidkaras23@gmail.com' #storing the receiver's mail id
password='hello1234@5' #storing the password to log in
